...
### 12. The Weapon-Specific Structures (weapon.w) and the Entity Instance-Specific Table hooks (weapon.s)
...
This article documents various Weapon functions and methods.
