...
- When you're done making your animation on the rig with the controller bones, *if they aren't already*, key every single keyframe on the in-engine rig as well (go on every frame, select all the bones with A, press K, keyframe whole character, selected bones). Unless the animation is VERY long, this shouldn't be too tedious.
