...
- The camera bone must always be at the world origin in blender (offset the IN-ENGINE armature by -63 on Z **AFTER** baking then APPLY THE TRANSFORMS to the rig so as to not mess up the animation). If you want to skip this step, you will have to animate with the offset applied from the beginning.
